...
def maj_forme_retour():
    data = pandas.read_csv("C:\\Users\\Vincent\\Desktop\\Entreprise\\Passerellepy\\Commande_en_traitement.csv",sep ='|', dtype="string")
    data = data.sort_values(by=['Credit Slip Number'], ascending=False)
    #print(data)
    data.to_csv("C:\\Users\\Vincent\\Desktop\\Entreprise\\Passerellepy\\Commande_en_traitement.csv", index=False, encoding='UTF-8', sep ='|')

    return None

def maj_forme_commande():
    fic = open("C:\\Users\\Vincent\\Desktop\\Entreprise\\Requête csv\\exported_orders14.csv",'r',encoding='UTF-8')
    fic2 = open("C:\\Users\\Vincent\\Desktop\\Entreprise\\Passerellepy\\Commande_en_traitement.csv",'w',encoding= 'UTF-8')
...
def order_limit():
    #last_order = 0
    fic = open("C:\\Users\\Vincent\\Desktop\\Entreprise\\Passerellepy\\last_order.txt", 'r')
...
def rewrite_LO(last_o, last_r):
    fic = open("C:\\Users\\Vincent\\Desktop\\Entreprise\\Passerellepy\\last_order.txt", 'w')
...
def validate_xml(ficxml):
    flag = False
    theDtd = "C:\\Users\\Vincent\\Desktop\\Entreprise\\Passerellepy\\ProshopVente.dtd"
...
def creatree_order():
    maj_forme_commande()
    fic = open("C:\\Users\\Vincent\\Desktop\\Entreprise\\Passerellepy\\Commande_en_traitement.csv",'r',encoding='UTF-8')
    fic.readline()
    flagfin = False
...
def creatree_return(proshop):
    maj_forme_retour()
    fic_retour = open("C:\\Users\\Vincent\\Desktop\\Entreprise\\Passerellepy\\Commande_en_traitement.csv",'r',encoding='UTF-8')
    fic_retour.readline()
    flag_retour = True
...
def crea_xml(proshop, rw_order, rw_return):
    ...
    varxmltest = "C:\\Users\\Vincent\\Desktop\\Entreprise\\Passerellepy\\Test.xml"
...
csv_file = open("C:\\Users\\Vincent\\Desktop\\Entreprise\\Passerellepy\\Commande_en_traitement.csv",'r',encoding='UTF-8')
csv_file.close()
os.remove("C:\\Users\\Vincent\\Desktop\\Entreprise\\Requête csv\\exported_orders14.csv")
#input()